    ...
    >
      ...
      {showPageNumber && typeof pageNumber === 'number' ? (
        <div
          ...
          style={{
            left: VTSD_MARGENS_A4.badge_pagina.x_px,
            top: VTSD_MARGENS_A4.badge_pagina.y_px,
            width: VTSD_MARGENS_A4.badge_pagina.largura_px,
            height: VTSD_MARGENS_A4.badge_pagina.altura_px,
            backgroundColor: VTSD_MARGENS_A4.badge_pagina.cor_bg || VTSD_COLOR.primary_dark,
            color: VTSD_MARGENS_A4.badge_pagina.cor_texto,
            borderRadius: VTSD_MARGENS_A4.badge_pagina.border_radius,
          }}
          aria-hidden
        >
          {pageNumber}
