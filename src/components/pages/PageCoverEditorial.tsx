...
export function PageCoverEditorial({
  ...
  if (variant === 'vtsd') {
    ...
    const nomeNorm = nomeCurso.trim().toLowerCase();
    const showSubtitle =
      Boolean(subtitleTrim) && subtitleTrim.toLowerCase() !== nomeNorm;
    ...
    return (
      ...
      >
        ...
        >
          {/* Nome do curso omitido: já consta na arte/logo da capa */}
          <h1
            className="mt-0 font-sora font-bold text-[32px] leading-[1.12] tracking-[-0.02em] m-0 max-w-[95%]"
