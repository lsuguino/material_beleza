...
export function PageIntro({
  ...
  return (
    ...
    >
      {heroSrc ? (
        <div className="w-full flex-shrink-0 overflow-hidden" style={{ maxHeight: '70mm' }}>
          <img src={heroSrc} alt="" className="w-full h-full object-cover block" style={{ maxHeight: '70mm' }} />
        </div>
      ) : null}
