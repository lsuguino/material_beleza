...
export const VTSD_MARGENS_A4 = {
  ...
  badge_pagina: {
    ...
    cor_bg: '#0599A8',
    cor_texto: '#FFFFFF',
    _nota: 'Badge 40×36px colado na borda inferior da página. Arredondado no topo (8px). Centralizado horizontalmente.',
  },
...
export const VTSD_COLOR = {
  ...
  branco: '#FFFFFF',
  fundo_page: '#FFFFFF',
  /** Colunas de texto / áreas de conteúdo (antes cinza claro; PDF com fundo branco) */
  fundo_box: '#FFFFFF',
  fundo_subtle: '#F6F6F6',
  fundo_dark: '#0C1520',
  /** Página ou faixa “externa” ao bloco principal (antes #C4C4C4; alinhado ao branco da folha) */
  fundo_externo: '#FFFFFF',
 ...
 * Alinhada ao Figma (📖 Book DS > Design System — Tipografia).
 *
 * | Token   | Fonte           | Tamanho | LH   | Uso                              |
 * |---------|-----------------|---------|------|----------------------------------|
 * | Display | Sora Bold       | 96px    | 100% | Número decorativo de capítulo     |
 * | H1      | Sora Bold       | 32px    | 110% | Título de página / capítulo       |
 * | H2      | Sora Bold       | 22px    | 120% | Subtítulo, seção, sidebar title   |
 * | H3      | Sora Bold       | 16px    | 130% | Card title, conceito, etapa       |
 * | Body    | Inter Regular   | 13px    | 170% | Texto principal de corpo          |
 * | Label   | Inter Semi Bold | 11px    | 140% | Overline, tags, capítulo label    |
 * | Quote   | Inter Italic    | 13px    | 170% | Citações em bloco                 |
 * | Badge   | Inter Semi Bold | 11px    | auto | Número da página                  |
 *
 * Regra: títulos em sidebars ≤250px usam H2 (22px) em vez de H1 (32px).
 * Regra: letter-spacing em labels/overlines = 1px (100%).
 */
