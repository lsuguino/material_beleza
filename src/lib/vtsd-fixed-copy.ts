/**
 * Texto fixo da página de introdução — Venda Todo Santo Dia (VTSD).
 * Usado no preview/PDF quando curso_id === 'geral' ou tema VTSD.
 */

export const VTSD_WELCOME_KICKER = 'Bem-vindo(a) ao';

export const VTSD_WELCOME_TITLE_LINE_1 = 'Venda Todo';
export const VTSD_WELCOME_TITLE_LINE_2 = 'Santo Dia';

export const VTSD_INTRO_BODY_PARAGRAPHS: string[] = [
...
export const VTSD_INTRO_SIGNOFF_LINES: string[] = [
  'Abraços,',
