...
/** Página de conclusão (fundo a partir da referência; texto em HTML — ver `vtsd-conclusao-copy`) */
export const PAGINA_CONCLUSAO_VTSD_FUNDO = '/capas/venda-todo-santo-dia/pagina-conclusao-fundo.svg';
