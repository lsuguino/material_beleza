...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR" className={`${inter.variable} ${lexend.variable} ${lora.variable} ${sora.variable}`}>
      <body className="font-display antialiased min-h-screen flex flex-col overflow-hidden bg-slate-100 dark:bg-background-dark text-slate-900 dark:text-slate-100">
        {children}
      </body>
    </html>
  );
